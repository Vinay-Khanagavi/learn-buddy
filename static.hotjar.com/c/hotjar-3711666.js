...
!(function () {
  ...
  var s,
    ...
    p = function (e, t) {
      ...
      return (
        "lab" === e && (n = l.browser.inLab),
        "field" === e && (n = d.isFieldMetricsEnabled),
        t ? n && t.flush : n
      );
    },
    m = function (e) {
    ...
    v = {
      ...
      start: function () {
        try {
          ...
          return (
            ...
            (d.isDebugEnabled =
              Math.random() <= o.universalDebug ||
              (a.has("client_script.metrics.debug") &&
                Math.random() <= o.debug)),
            (d.isMetricsEnabled = Math.random() <= o.metrics),
            (d.isFieldMetricsEnabled =
              d.isMetricsEnabled && Math.random() <= o.fieldMetrics),
            (s = new i(m, l.buffer.bufferSize, l.buffer.flushInterval)),
            e
          );
        } catch (e) {
      ...
      timeIncr: function (e, t) {
        ...
        return (
          f(e, m.tagName, { total: w }),
          c && v.timeEnd(e, { tag: s, total: w, extraTags: u, type: l }),
          w
        );
      },
  ...
  var w,
    ...
    M = !(
      window.CS_CONF ||
      !(
        (null !== (c = window.hjSiteSettings.features) &&
          void 0 !== c &&
          c.includes("cs_lite")) ||
  ...
  if (
    ((window.hjLazyModules = window.hjLazyModules || {
      SURVEY_V2: { js: "survey-v2.c62ba7901869cfebe15e.js" },
      SURVEY_BOOTSTRAPPER: {
        js: "survey-bootstrapper.1db817a3108bf3677001.js",
      },
      SURVEY_ISOLATED: { js: "survey-isolated.6a93bacb85437b469444.js" },
      HEATMAP_RETAKER: { js: "heatmap-retaker.f79c0c7bb13d8a14bddc.js" },
      SURVEY_INVITATION: { js: "survey-invitation.541394d8415936d82538.js" },
      ...
      USER_TEST: { js: "user-test.10f4c30183bc29543d35.js" },
    }),
    T)
  )
    ...
    (window.CS_CONF_BASE =
      ((S = (y =
        (w = window.hjSiteSettings).suppress_all ||
        w.suppress_text ||
        (null === (b = w.suppress_all_on_specific_pages) || void 0 === b
          ? void 0
          : b.length))
        ? (function (e) {
            var t, n, r, i, a, s;
            if (
              ((e.suppress_all || e.suppress_text) && (n = ".*"),
              ...
              o && (n = null == o ? void 0 : o.pattern),
                (i = e.suppress_all_on_specific_pages),
                (a = {
                  contains: "contain",
                  ends_with: "end",
                  exact: "exact",
        ...
        : null),
      {
        ...
        voc:
          (null !== (j = w.feedback_widgets) && void 0 !== j && j.length) ||
          (null !== (_ = w.polls) && void 0 !== _ && _.length)
            ? { enabled: 1, siteId: w.site_id }
            : { enabled: 0 },
        whitelistedAttributes:
          !y && w.recording_capture_keystrokes ? ["data-hj-allow"] : [],
    ...
    R &&
      ...
      (O = "t-staging.contentsquare.net"));
    var x = document.createElement("script");
    (x.type = "text/javascript"),
      (x.async = !0),
      (x.src = "//".concat(O, "/uxa/smb/tag.js")),
